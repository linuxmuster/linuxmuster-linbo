...
ifeq ($(BR2_x86_64),y)
GRUB2BIOS_IMGS = boot boot_hybrid cdboot diskboot kernel lnxboot lzma_decompress pxeboot
GRUB2BIOS_MODS = \
...
GRUB2BIOS_CHECK_BIN_ARCH_EXCLUSIONS = \
	$(patsubst %,/usr/lib/grub/i386-pc/%.mod,$(GRUB2BIOS_MODS)) \
	$(patsubst %,/usr/lib/grub/i386-pc/%.img,$(GRUB2BIOS_IMGS))
endif
